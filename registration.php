...
$query="insert into  registration(id,roomno,seater,location,feespm,stayfrom,
firstName,lastName,gender,contactno,emailid,egycontactno,
guardianName,guardianRelation,guardianContactno,pmntCity) 
values('$aid','$roomno','$seater','$location','$feespm','$stayfrom','$fname',
'$lname','$gender','$contactno','$emailid','$emcntno','$gurname','$gurrelation','$gurcntno','$pcity')";
//$stmt = $mysqli->prepare($query);
//$rc=$stmt->bind_param('iiiisisissssisississsisssi',$roomno,$seater,
//$feespm,$stayfrom,$duration,$fname,
//$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,
//$gurcntno,$pcity);
//$stmt->execute();
...
if (mysqli_query($mysqli, $query)) {
  ...
  //  echo '</b> <a href="login.html">Click here to Login</a> </b>';
  } else {
    echo "Error: ";
  }
...
?>
 ...
 <input type="text" name="location" id="seater" value="<?php echo $row->location;?>" class="form-control" readonly="true"  >
<?php } ?>
</div>
</div>
...
<div class="col-sm-8">
<input type="date" name="stayf" id="stayf"  class="form-control" required="required>
</div>
</div>
...
<center><span><h1><label><h4 style="color: green" align="left">Personal info </h4> </label></h1></span></center>
...
<div class="form-group">
<label class="col-sm-3 control-label"><h4 style="color: green" align="left">Home_Address </h4> </label>
</div>
