...
$dt= $_GET['dt'];
echo "FROM $df TO $dt ";
$select=mysqli_query($mysqli,"SELECT * FROM cincome WHERE id=$aid AND date BETWEEN '$df' AND '$dt'");
...
$df= $_GET['df'];
$dt= $_GET['dt'];
$result ="SELECT sum(fees) FROM cincome where id=? AND date BETWEEN '$df' AND '$dt' ";
