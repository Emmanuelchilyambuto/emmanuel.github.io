			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">COMPLET REPORT</h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">COMPLET REPORT</div>
...
$df= $_GET['df'];
$dt= $_GET['dt'];
$result ="SELECT sum(fees) FROM income where id=? AND date BETWEEN '$df' AND '$dt' ";
$stmt = $mysqli->prepare($result);
$stmt->bind_param('i',$aid);
$stmt->execute();
$stmt->bind_result($su);
...
?>
<label for="te"><b></b>TOTAL INCOME</label>	
							<input type="text" value="K<?php 
							echo $su ?>" Readonly="readonly">
							
								<label for="te"><b></b>TOTAL EXPENSE</label>	
							<input type="text" value="K<?php 
							echo $sum ?>" Readonly="readonly">
							
						<label for="te"><b></b>CURRENT BALANCE</label>	
							<input type="text" value="K<?php 
							echo $su-$sum ?>" Readonly="readonly">
							</div>
